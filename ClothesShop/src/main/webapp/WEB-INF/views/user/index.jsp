			...
			<div class="container-fluid">
				...
				<div class="best-product-style">
					<div
						...
						role="tablist">
						<a class="active" href="#home6" data-toggle="tab" role="tab">
							<h4>Fiction</h4>
						</a> <a href="#home7" data-toggle="tab" role="tab">
							<h4>Satire</h4>
						</a> <a href="#home8" data-toggle="tab" role="tab">
							<h4>Anthologies</h4>
						</a> <a href="#home9" data-toggle="tab" role="tab">
							<h4>Art</h4>
						</a> <a href="#home10" data-toggle="tab" role="tab">
							<h4>Journals</h4>
						</a> <a href="#home11" data-toggle="tab" role="tab">
							<h4>History</h4>
						</a>
					</div>
					<div class="tab-content">
						...
						<div class="tab-pane fade" id="home10" role="tabpanel">
							<div class="custom-row">
								<div class="custom-col-5 custom-col-style mb-95">
									<div class="product-wrapper">
										<div class="product-img-2">
